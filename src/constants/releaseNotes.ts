...
export const RELEASE_NOTES: ReleaseNote[] = [
  {
    ...
    features: [
      {
        title: 'release_notes.mar_31.postonly_title',
        description: 'release_notes.mar_31.postonly_desc',
      },
      {
        title: 'release_notes.mar_31.pricing_title',
        description: 'release_notes.mar_31.pricing_desc',
      },
      {
        title: 'release_notes.mar_31.autosell_title',
        description: 'release_notes.mar_31.autosell_desc',
      },
    ],
  },
  {
    ...
    features: [
      {
        title: 'release_notes.mar_25.session_title',
        description: 'release_notes.mar_25.session_desc',
      },
      {
        title: 'release_notes.mar_25.timeout_title',
        description: 'release_notes.mar_25.timeout_desc',
      },
      {
        title: 'release_notes.mar_25.stoploss_title',
        description: 'release_notes.mar_25.stoploss_desc',
      },
    ],
  },
  {
